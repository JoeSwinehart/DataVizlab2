...
#this is awful and should be burned. I disavow this work.
trends_clean %>% 
  ggplot(aes(date, Ranking, color = Hurricane)) + 
  geom_ribbon(aes(ymin = Ranking - 1, ymax = Ranking + 1), fill = "cornflowerblue") 
